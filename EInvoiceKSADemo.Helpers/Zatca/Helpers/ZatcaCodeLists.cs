        ...
        public static List<ZatcaItem> VatCategories
        {
            get
            {
                return new List<ZatcaItem>()
                {
                    ...
                    new ZatcaItem("Standard rate","S"), // Tax > 5 , Or 15 .
                    new ZatcaItem("Zero rated goods", "Z")
                    {
                        SubItems = new List<ZatcaItem>
                        {
                            ...
                            new ZatcaItem ("VATEX-SA-DUTYFREE","Qualified Supply of Goods in Duty Free area","التوريد المؤهل للسلع في منطقة السوق الحرة")
                        }
                    },
