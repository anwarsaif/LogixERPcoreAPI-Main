...
{
    public class SysZatcaInvoiceTransactionRepository : GenericRepository<SysZatcaInvoiceTransaction>, ISysZatcaInvoiceTransactionRepository
    {
        private readonly IConfiguration configuration;
        private readonly ICurrentData session;

        public SysZatcaInvoiceTransactionRepository(ApplicationDbContext context,
        ...
        public async Task<DataTable> GetTransactions(ZatcaInvoiceFilterDto filter)
        {
            try
            {
                ...
                using (SqlCommand objCmd = objCnn.CreateCommand())
                {
                    ...
                    objCmd.CommandText = "ZatcaTransactions";
